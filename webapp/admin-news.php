...
<?php if(isset($_REQUEST['success'])=="done")
    ...
    <div class="row my-4">
        ...
        <form action="php/create-news.php" method="POST" enctype="multipart/form-data" accept-character="utf-8">
        <div class="card">
            ...
            <div class="form-group">
                <label for="exampleSong">News image</label>
                <input type="file" class="form-control-file" name="img">
                <small id="emailHelp" class="form-text text-muted">Upload your image for news</small>
            </div>
            <div class="form-group">
                <label for="Songname">Give News title:</label>
                <input type="text" class="form-control" name="title" placeholder="Song">
            </div>
            <div class="form-group">
